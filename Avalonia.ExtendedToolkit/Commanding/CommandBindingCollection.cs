...
{
    public class CommandBindingCollection : IList
    {
        //------------------------------------------------------
        //
        //  Constructors
        ...
        public int Add(CommandBinding commandBinding)
        {
            if (commandBinding != null)
            {
                ...
                CommandManager.AddCommandBinding(commandBinding);
            ...
            if (collection.Count > 0)
            {
                ...
                while (collectionEnum.MoveNext())
                {
                    ...
                    if (cmdBinding != null)
                    {
                        ...
                        CommandManager.AddCommandBinding(cmdBinding);
                    }
                    else
                    {
                        throw new NotSupportedException();
        ...
        public void Clear()
        {
            ...
            {
                _innerCBList.Clear();
                _innerCBList.ForEach(x => CommandManager.RemoveCommandBinding(x));
                _innerCBList = null;
            }
        }
        ...
        //internal ICommand FindMatch(object targetElement, EventArgs inputEventArgs)
        //{
